...
public class ReportListAdapter extends RecyclerView.Adapter<ReportListAdapter.ItemListViewHolder> implements ItemTouchHelperAdapter {
    ...
    public ReportListAdapter(Context mContext, ArrayList<ItemInfo> mItemInfoList, ItemListClickListener mListener) {
    ...
    public ItemListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemListViewHolder(LayoutInflater.from(mContext).inflate(R.layout.activity_report_list_adapter, parent, false));
    }
